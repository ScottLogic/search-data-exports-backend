module.exports = ({ svgString = '', textInformation = '', tableData = [] }) => {    
    ...
    tableData.forEach(item => { tableinformation +=  `<tr><td>${item.tag}</td><td>${item.count}</td></tr>`; });
    ...
    <body>
        ...
        <div class="page-content">
            ...
            <div class="page-content-col page-content-col-right">
                <h3>Hybrid Report</h3>
                <p>This report is generated from a svg and table text, combined together via a HTML template which is used to format a PDF output. Benifits Include</p>
                <ul>
                    <li>Easy to maintain template layout</li>
                    <li>Use of stlying for elements.</li>
                    <li>Includes SVG support</li>
                    <li>Template can be used to generate HTML as well, for onscreen reports as well. </li>
                </ul>
                ${textInformation}
            </div>
        </div>
